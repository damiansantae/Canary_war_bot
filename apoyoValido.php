...
<body>
	...
	<div class="main-area center-text" style="background-image:url(images/validation-bg.jpg);" >
		<div class="display-table">
			<div class="display-table-cell">	
			<h2 class="desc font-white">¡Tu apoyo ha sido validado! </h2>	
				<p class="desc font-white">Tu municipio te lo agradecerá a la hora de la batalla, ¡estate atento a todas las novedades!</p>						
                <div id="normal-countdown" data-date="2019/06/11"></div><br>
                <button class="btn btn-success" id="back-button">
